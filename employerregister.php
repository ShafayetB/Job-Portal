        ...
        <div class="dez-bnr-inr overlay-black-middle bg-pt" style="background-image:url(images/banner/bnr2.jpg);">
            <div class="container">
                <div class="dez-bnr-inr-entry">
                    <h1 class="text-white">Employer Register</h1>
					<!-- Breadcrumb row -->
					...
					<div class="col-md-12 m-b30">
						<div class="p-a30 border-1  max-w500 m-auto">
							<div class="tab-content">
								<form id="login" class="tab-pane active" action="process_employer_register.php" method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
										<label class="font-weight-700">Company name</label><br>
										<INPUT TYPE = "TEXT" name="cnm" style="width:200px;" class="form-control">
									</div>
                                    <div class="form-group">
										<label class="font-weight-700">Company address</label>
									...
									<div class="form-group">
										<label class="font-weight-700">Company Profile</label>
